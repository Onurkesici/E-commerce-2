                        ...
                        <div class="personal-info inner-page-padding">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Urun Eklenme Tarihi</th>
                                ...
                                <tbody>
                                    ...
                                    while ($uruncek = $urunsor->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="urun-duzenle?urun_id=<?php echo $uruncek["urun_id"] ?>"><button
                                                        class="btn btn-primary btn-xs">Duzenle</button></a></td>

                                            <?php if ($uruncek["urun_durum"] == 0) { ?>
                                                <td><button class="btn btn-warning btn-xs">Onay Bekliyor</button></td>

                                            <?php } else { ?>
                                                <a onclick="return confirm('Bu urunu silmek istiyor musunuz?')"
