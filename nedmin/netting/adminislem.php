...
if (isset($_POST["adminkullaniciduzenle"])) {
	...
	if ($update) {
		...
		header("Location:../production/kullanici-duzenle?durum=ok&kullanici_id=$kullanici_id");

	} else {

		header("Location:../production/kullanici-duzenle?durum=no&kullanici_id=$kullanici_id");
