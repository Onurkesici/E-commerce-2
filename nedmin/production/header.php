      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-money"></i> <span>E-commence</span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
             ...
             <li><a href="magazalar.php"><i class="fa fa-shopping-basket"></i> Magazalar </a></li>

             <li><a href="magaza-onay.php"><i class="fa fa-shopping-basket"></i> Magaza Basvurulari </a></li>
